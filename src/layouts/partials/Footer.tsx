    ...
    <footer className="pt-25">
      <div className="container">
        ...
        <motion.div
          ...
          className="lg:sticky bottom-0 z-0"
        >
          <h1 className="footer-title leading-tight mt-20 ">
            {config.site.title}
          </h1>
          <div className="flex justify-between lg:-translate-y-12 items-center flex-col sm:flex-row gap-y-6">
            <p
